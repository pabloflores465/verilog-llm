...
# === INSTALL DEPS ===
for pkg in ["bitsandbytes>=0.46.1", "transformers", "peft", "trl", "datasets", "accelerate", "huggingface-hub", "sentencepiece", "protobuf"]:
...
if not HF_TOKEN:
    raise ValueError("HF_TOKEN not set. Add it to Kaggle Secrets.")

print("=" * 60)
print("VERILOG SOTA TRAINING")
print("=" * 60)
...
print("SFTTrainer args:", sorted(sft_args))
...
print(f"Final: {HUB_MODEL_ID}/adapter_v1")
print("=" * 60)
